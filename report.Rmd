...
library(knitr)
kable(state_par, caption = "Table 3. Sorted parameters and state variabes.", row.names = FALSE)
...
```{r echo = FALSE, results = "asis"}
library(knitr)
kable(par_tab, caption = "Table 4. Parameters used in Q12-15", row.names = TRUE)
...
This document last modified: 03 February 2021 by TNM.
