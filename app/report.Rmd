...
## Optional pre-class readings, videos, and activity:
...
| | |
| --- | --- |
| `r substr(quest["q5a", ], 3, nchar(quest["q5a", ]))` | --- |
| `r substr(quest["q5b", ], 3, nchar(quest["q5b", ]))` | --- |
| `r substr(quest["q5c", ], 3, nchar(quest["q5c", ]))` | --- |
| `r substr(quest["q5d", ], 3, nchar(quest["q5d", ]))` | --- |
| `r substr(quest["q5e", ], 3, nchar(quest["q5e", ]))` | --- |
...
\
    ...
    \
    c.  `r substr(quest["q8c", ], 3, nchar(quest["q8c", ]))`: 
\

9. `r module_text["state_var", 1]` `r module_text["parameter", 1]` `r substr(quest["q9", ], 6, nchar(quest["q9", ]))` 
\
...
*Figure 2. Modeled primary productivity for your selected NEON lake compared to chlorophyll-a concentrations, a proxy measurement for aquatic primary productivity.*
...
*Figure 3. Weather forecast plot at the selected NEON lake generated from National Oceanic and Atmospheric Administration (NOAA)  [Global Ensemble Forecast System](https://www.ncdc.noaa.gov/data-access/model-data/model-datasets/global-ensemble-forecast-system-gefs)  (GEFS).* 
...
*Figure 4. Ecological forecast for primary productivity at your selected NEON lake for the next 30 days.*  
...
*Figure 5. Assessment of the forecast one week later and comparing the forecast to new observations at your selected NEON lake.*   
...
*Figure 7. The next ecological forecast using the updated model parameters at your selected NEON lake site.*  
...
This module was developed by Moore, T.N., M.E. Lofton, C.C. Carey, and R.Q. Thomas. 22 May 2023. Macrosystems EDDIE: Introduction to Ecological Forecasting. Macrosystems EDDIE Module 5, Version 2. http://module5.macrosystemseddie.org. Module development was supported by NSF grants DEB-1926050 and DBI-1933016.

This document last modified: 22 May 2023 by MEL.
